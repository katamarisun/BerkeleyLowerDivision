...
'('cons '(1 2))
; expect ((quote cons) (quote (1 2)))

(and 1 0 false (/ 3 0))
; expect False
(let ((meow (lambda (y) (- y 4))) (moo 4)) (meow moo))
; expect 0

((((lambda (y) (lambda (x) (lambda (z) (+ x y z)))) 1) 2) 3)
; expect 6

(and (or) (and) 0 'a 9)
; expect False

(define (elections electoral popular)
  (cond
    ((and (> electoral 270) (< popular 45000000)) '(Lol america isnt a democracy sux to suck))
    ((and (< electoral 270) (< popular 45000000)) '(You lost sux to suck))
    (else '(Yay u won gratz))
    )
  )
; expect elections
(elections 281 15)
; expect (Lol america isnt a democracy sux to suck)

(append (list 3 4  5 6 7 7 ) (list 'meow))
; expect (3 4 5 6 7 7 meow)
